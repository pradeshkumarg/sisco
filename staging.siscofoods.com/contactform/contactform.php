...
$contact_email_to = "ashok@siscofoods.com";
...
// Number invalid error text
$contact_error_contactnumber = "Please enter a valid number!";
...
if(isset($_POST)) {
  ...
  $contactnumber = filter_var($_POST["contactnumber"], FILTER_SANITIZE_EMAIL);
